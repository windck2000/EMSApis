...
namespace EMSApi.Migrations
{
    ...
    [Migration("20230318020619_updadepartments2")]
    partial class updadepartments2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMSApi.Dbcontext.Departments", b =>
                {
                    ...
                    b.Property<string>("DepartmentsPosition")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("EMSApi.Dbcontext.Files", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SYS_PROJECTFILE");
                });

            modelBuilder.Entity("EMSApi.Dbcontext.Functions", b =>
                {
                    b.Property<string>("FunctionsSublevel")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("BlIco")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FunctionsName")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("FunctionsRemarks")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("MqIco")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("FunctionsSublevel");

                    b.ToTable("SYS_FUNCTIONS");
                });
            ...
            modelBuilder.Entity("EMSApi.Dbcontext.Permissioncs", b =>
                {
                    ...
                    b.Property<string>("PermissioncsType")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
